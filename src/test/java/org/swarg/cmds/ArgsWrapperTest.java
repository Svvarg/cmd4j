...
//    }
    ...
    public void testOptIndex() {
        ...
        assertEquals(-1, w.optKeyIndex("-x"));
        assertEquals(-1, w.optKeyIndex("cmd"));
        assertEquals(-1, w.optKeyIndex("true"));

        assertEquals(1, w.optKeyIndex("-go"));
        assertEquals(2, w.optKeyIndex("-path"));
        assertEquals(4, w.optKeyIndex("-speed"));
        assertEquals(6, w.optKeyIndex("-mode"));
        assertEquals(7, w.optKeyIndex("-verbose","-v"));
    }
